...
public class Block {
  ...
  public Boolean isGenesisBlock() {
    return blockHeader.getIndex().equals("0");
  }
  ...
  public String toString() {
    ...
    sb.append("Block{")
        .append("blockIri=").append(blockIri).append(", ")
        .append("blockHeader=").append(blockHeader).append(", ")
        .append("blockContent(size)=").append(blockContent.getTriples().size())
        .append("}");
    return sb.toString();
  }
